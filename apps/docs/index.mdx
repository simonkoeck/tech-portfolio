...
<Columns cols={3}>
  ...
  <Card title="Security" icon="shield-halved" href="/api-reference/security/stats">
...
Creator of [shipsecu.re](https://shipsecu.re) — I've tested **20+ companies** for security vulnerabilities, reported CVEs, and participated in bug bounty programs. Check out the [Security API](/api-reference/security/stats) for the data.
